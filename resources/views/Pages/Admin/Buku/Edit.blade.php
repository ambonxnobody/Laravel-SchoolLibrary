                    ...
                    <div class="card-body">
                        <form action="/buku/{{ $buku->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input id="jumlah" name="jumlah" type="number"
                                        class="form-control @error('jumlah') is-invalid @enderror" value="0" required>
                                    <p class="text-secondary">Jika Ada Tambahan atau Pengurangan Stok, Tulis Nilai Sesuai
                                        Tambahan atau Pengurangan Stok!</p>
                                    @error('jumlah')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <input type="hidden" name="oldImage" value="{{ $buku->cover }}">
                                <div class="col-sm-12 col-md-7">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <textarea name="sinopsis" class="summernote-simple">{{ old('sinopsis', $buku->sinopsis) }}</textarea>
                                    @error('sinopsis')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input id="halaman" name="halaman" type="number"
                                        ...
                                        value="{{ old('halaman', $buku->halaman) }}" min="1">
                                    @error('halaman')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row mb-4">
                                <label for="tahunRilis" class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tahun
                                    Rilis</label>
                                <div class="col-sm-12 col-md-7">
                                    <input id="tahunRilis" name="tahunRilis" type="number" max="9999"
                                        min="1" class="form-control @error('tahunRilis') is-invalid @enderror"
                                        value="{{ old('tahunRilis', $buku->tahunRilis) }}">
                                    @error('tahunRilis')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input id="keterangan" name="keterangan" type="text"
                                        ...
                                        value="{{ old('keterangan', $buku->keterangan) }}">
                                    @error('keterangan')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
