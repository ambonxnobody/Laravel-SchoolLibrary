                                    ...
                                    @foreach ($siswas as $siswa)
                                        @foreach ($siswa->peminjamen as $peminjaman)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span
                                                        class="badge rounded-pill text-white {{ $peminjaman->status == 'Dipinjam' ? 'bg-warning' : ($peminjaman->status == 'Waktunya Dikembalikan' ? 'bg-danger' : 'bg-secondary') }}">{{ $peminjaman->status }}</span>
                                                </td>
                                                <td class="text-center">
